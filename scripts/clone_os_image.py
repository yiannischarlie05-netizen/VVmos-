...
async def download_images(pad_code: str, output_dir: str):
    ...
    print(f"            --pad {pad_code} --vps 51.68.33.34:18999 \\")
    print(f"            --partitions system,system_ext,product,vendor,odm")
    print(f"       Then: wget http://51.68.33.34:18999/os_extract/<file>.img.gz")
    print(f"")
...
async def clone_via_direct(source_pad: str, target_pad: str):
    ...
    vps_url = "http://51.68.33.34:18999/clone_transfer"
...
async def main():
    ...
    parser.add_argument("--vps", default="51.68.33.34",
