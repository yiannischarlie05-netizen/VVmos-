...
Usage:
  python3 scripts/extract_os_image.py --pad APP6476KYH9KMLU5 --vps 51.68.33.34:19000
...
AK = os.environ.get("VMOS_AK", "BPWNWxfXMQsjsREyzIOXmCtndRZO8iVi")
SK = os.environ.get("VMOS_SK", "Q2SgcSwEfuwoedY0cijp6Mce")
