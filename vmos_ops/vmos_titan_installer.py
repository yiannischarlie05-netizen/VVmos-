...
class VmosTitanInstaller:
    ...
    async def step_05_create_environment_config(self):
        ...
        env_config = {
            "vmos_cloud": {
                ...
                "access_key": os.getenv("VMOS_CLOUD_AK", "BPWNWxfXMQsjsREyzIOXmCtndRZO8iVi"),
                "secret_key": os.getenv("VMOS_CLOUD_SK", "Q2SgcSwEfuwoedY0cijp6Mce"),
                "rate_limit": {
                    "delay_seconds": 3.5,
                    "max_concurrent": 10,
                    "retry_max": 3
    ...
    async def step_06_create_credentials_file(self):
        ...
        credentials = {
            "vmos_cloud": {
                "access_key_id": os.getenv("VMOS_CLOUD_AK", "BPWNWxfXMQsjsREyzIOXmCtndRZO8iVi"),
                "secret_access_key": os.getenv("VMOS_CLOUD_SK", "Q2SgcSwEfuwoedY0cijp6Mce"),
                "created": os.times()[4],
                "version": "1.0"
            },
            "google_account": {
